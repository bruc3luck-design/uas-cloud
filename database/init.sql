...
VALUES
  ...
  (3, 1, 'Deploy Web Statis CV',
      'Build image dari folder static-cv dan push ke Docker Hub gamine1/uas-static.',
      'in_progress', 'high', '2026-06-05'),

  (4, 1, 'Deploy Web Dinamis PHP MariaDB',
      'Build image dari folder dynamic-app dan push ke Docker Hub gamine1/uas-dinamic.',
      'in_progress', 'high', '2026-06-05'),
