...
VALUES
  (1, 'Setup AWS EC2 Instance',
      'Buat instance UAS-2388010022 di region ap-southeast-1, konfigurasi security group port 80 dan SSH.',
  ...
  (1, 'Deploy Web Statis (CV)',
      'Build image dari folder static-cv, push ke Docker Hub gamine1/uas-static, running di container.',
      'in_progress', 'high', '2026-06-05'),

  (1, 'Deploy Web Dinamis (PHP + MariaDB)',
      'Build image dari folder dynamic-app, push ke Docker Hub gamine1/uas-dinamic, uji CRUD.',
      'in_progress', 'high', '2026-06-05'),
